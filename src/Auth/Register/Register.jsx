...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    setLoader(true);
    await Axiosintance.post(API.register, data)
      .then((res) => {
        console.log(res);
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={12} lg={5}>
              <Box className="login_sec_right">
                <h1>
                  New Member register <span>Hope You are doing well</span>
                </h1>
...
//     console.log(data);
//     navigateToContacts(data.email);
//   };

//   const navigateToContacts = (email) => {
...
//             {/* Password input field using TextField */}
//             <Box className="login_input">
//               <TextField
//                 id="standard-basic"
//                 label="Password"
